...
class SMP_Odnoklassniki_Provider extends SMP_Provider {
	...
	public static function is_active() {
		return SMP_Options::get_option( 'setting_use_odnoklassniki' );
	}
	...
	public static function options() {
		return array(
			...
			'tab_caption'         => SMP_Options::get_option( 'setting_odnoklassniki_tab_caption' ),
			'css_class'           => 'odnoklassniki-tab',
			'icon'                => 'fa-odnoklassniki',
			'url'                 => esc_attr( SMP_Options::get_option( 'setting_odnoklassniki_group_url' ) ),
		);
	}
	...
	public static function container() {
		...
		$content .= 'OK.CONNECT.insertGroupWidget("smp_ok_group_widget", '
			. '"'       . esc_attr( SMP_Options::get_option( 'setting_odnoklassniki_group_id' ) ) . '", "{'
			. 'width:'  . absint( SMP_Options::get_option( 'setting_odnoklassniki_width' ) ) . ', '
			. 'height:' . absint( SMP_Options::get_option( 'setting_odnoklassniki_height' ) )
			. '}");';
