<div id="scp_welcome_screen" class="wrap">
	...
	<div class="box">
		...
		<h3>Версия 0.7.5 от 27.05.2017</h3>
		<ul>
			<li>Исправлена ошибка в работе виджета Facebook в браузере Firefox при отображении его на второй вкладке</li>
			...
			<li>Добавлена возможность отслеживания подписавшихся/отписавшихся в Google Analytics</li>
			<li>Добавлены понятные человеку подписи для всех текстовых полей в настройках плагина</li>
			<li>Добавлена визуализация меню при активном Режиме Отладки (фон выделяется красным цветом)</li>
