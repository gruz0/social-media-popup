<div id="scp_welcome_screen" class="wrap">
	...
	<div class="box">
		...
		<ul>
			<li>Добавлена возможность задать цвет и прозрачность фоновой заливки.</li>
			...
			<li>Удалёны отступы у изображений в описании виджета. Были проблемы с некоторыми темами.</li>
